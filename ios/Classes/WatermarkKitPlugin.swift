...
public class WatermarkKitPlugin: NSObject, FlutterPlugin {
  ...
  static func renderTextCGImage(text: String, fontFamily: String, fontSizePt: Double, fontWeight: Int, colorArgb: UInt32) throws -> CGImage? {
    ...
    guard let ctx2 = CGContext(data: nil, width: 1, height: 1, bitsPerComponent: 8, bytesPerRow: 0, space: CGColorSpace(name: CGColorSpace.sRGB)!, bitmapInfo: CGImageAlphaInfo.premultipliedLast.rawValue) else {
      return nil
    }
